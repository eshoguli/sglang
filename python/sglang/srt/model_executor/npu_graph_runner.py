...
class NPUGraphRunner(CudaGraphRunner):
    ...
    def __init__(self, model_runner: ModelRunner):
        ...
        self.backend = os.getenv("NPU_TORCH_COMPILE_BACKEND", "reduce-overhead")
    ...
    def capture(self) -> None:
        ...
        if self.enable_torch_compile:
            backend = get_compiler_backend(self.backend)
            ...
            if self.backend == "reduce-overhead":
    ...
    def replay(
        ...
        if self.enable_torch_compile and (self.backend == "reduce-overhead"):
