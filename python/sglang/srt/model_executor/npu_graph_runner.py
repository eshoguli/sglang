...
class NPUGraphRunner(CudaGraphRunner):
    ...
    def __init__(self, model_runner: ModelRunner):
        ...
        self.backend_name = os.getenv("NPU_TORCH_COMPILE_BACKEND", "reduce-overhead")
    ...
    def replay(
        ...
        if self.enable_torch_compile and (self.backend_name == "reduce-overhead"):
