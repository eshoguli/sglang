...
from sglang.srt.model_executor.piecewise_cuda_graph_runner import model_capture_mode
...
class PiecewiseNpuGraphRunner:
    """A PiecewiseNpuGraphRunner runs the forward pass of a model with npu graph and torch.compile."""

    def __init__(self, model_runner: ModelRunner):
        print(f"PiecewiseNpuGraphRunner::__init__: {os.getpid()}")
        patch_dynamo_context()
