...
class PiecewiseGraphRunner:
    ...
    # TODO: add compilation_config: CompilationConfig
    def __init__(self, model_runner: ModelRunner):
        print(f"PiecewiseGraphRunner::__init__")        
        model_runner.attn_backend.enable_piecewise_graph = True
    ...
    def replay(
        ...
        # print(f"PiecewiseGraphRunner::replay: {os.getpid()}", flush=True)
